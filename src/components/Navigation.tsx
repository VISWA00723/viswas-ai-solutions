      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            >
              <span className="text-xl sm:text-2xl font-bold bg-gradient-primary bg-clip-text text-transparent glow-text">
                Viswa VR
              </span>
            </motion.div>
            ...
            <div className="px-4 py-4 space-y-2">
              {navigationItems.map((item, index) => (
                <motion.button
                  ...
                  onClick={() => scrollToSection(item.href)}
                  className="block px-4 py-3 text-base font-medium text-muted-foreground hover:text-primary hover:bg-accent rounded-lg w-full text-left transition-all duration-300 magnetic-hover"
                >
                  {item.label}
                </motion.button>
              ))}
